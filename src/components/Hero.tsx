...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center pt-30 pb-20 bg-gradient-to-b from-primary via-primary to-primary relative">
      ...
      <div className="section-container">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-accent/5 border border-accent/20 rounded-full text-xs font-semibold text-accent tracking-wider uppercase mb-8 relative overflow-hidden animate-glow-pulse"
          >
          ...
          <motion.h1
            ...
            className="text-6xl md:text-7xl font-medium leading-none tracking-tight mb-8 bg-gradient-to-r from-white via-accent to-accent-green bg-clip-text text-transparent"
          >
            Outsourced risk management—<br />built for prop firms.
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl leading-relaxed text-text-secondary max-w-3xl mb-12"
          >
